...
b_i &\stackrel{ind.}{\sim} N(0, \sigma^2_a) \\
\gamma_j &\stackrel{ind.}{\sim} N(0, \sigma^2_b),
\end{split}\]
em que $i = 1, \dots, 4$ representa o estágio do câncer, $j = 1, \dots, 407$ representa o médico, $k = 1, \dots, n_{ij}$ é a repetição e toma-se $\beta_1=0$.
