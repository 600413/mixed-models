...
Matriz desing dos efeitos aleatórios de dimensão Zxk.
...
Vetor de parâmetros dos efeitos aleatórios de dimensão kx1.
...
Um exemplo do modelo nos dados das corujas, para o ninho *Forel* segue abaixo.
...
Form <- 'LogNeg~FoodTreatment+ArrivalTime'

rs1 <- reStruct(LogNeg~FoodTreatment+ArrivalTime, data = Owls)
model.matrix(rs1, Owls)
